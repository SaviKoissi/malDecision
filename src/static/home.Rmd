...
##Analysis:
Input your data and specify your analysis parameters using the provided scripts. Please insert a CSV file formatted as follows: 
...
Choose a variable cluster that represents the degree of urbanization

Select the classifiers (topo, precipitation, etc.) that represent the determinants

Choose the output variable (PC1)

With a single click, you can run the analysis
